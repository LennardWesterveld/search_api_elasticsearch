 ...
 *   description = @Translation("A connector usable for Elasticsearch installations protected by basic authentication.")
 * )
 */
class BasicAuthElasticsearchConnector extends StandardElasticsearchConnector {
  ...
  public function buildConfigurationForm(array $form, FormStateInterface $form_state) {
    ...
    $form['auth'] = array(
      ...
      '#description' => $this->t('If your Elasticsearch server is protected by basic HTTP authentication, enter the login data here.'),
      '#collapsible' => TRUE,
