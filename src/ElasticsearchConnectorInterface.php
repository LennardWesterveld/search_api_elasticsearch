...
namespace Drupal\search_api_elasticsearch;
 ...
 *
 */
interface ElasticsearchConnectorInterface extends ConfigurablePluginInterface {

  /**
   * Returns a link to the Elasticsearch server.
   *
  ...
  /**
   * Returns a link to the Elasticsearch core, if the necessary options are set.
   *
   * @return \Drupal\Core\Link
   */
  ...
  /**
   * Gets the current Elasticsearch version.
   *
   * @param bool $force_auto_detect
   *   If TRUE, ignore user overwrites.
   *
   * @return string
   *   The full Elasticsearch version string.
   */
  public function getElasticsearchVersion($force_auto_detect = FALSE);

  /**
   * Gets the current Elasticsearch major version.
   *
   * @param string $version
   *   An optional Elasticsearch version string.
   *
   * @return int
  ...
  /**
   * Gets the current Elasticsearch branch name.
   *
   * @param string $version
   *   An optional Elasticsearch version string.
   *
   * @return string
   *   The Elasticsearch branch string.
   */
  ...
  /**
   * Gets information about the Elasticsearch server.
   *
   * @param bool $reset
  ...
  /**
   * Gets information about the Elasticsearch Core.
   *
   * @param bool $reset
   *   If TRUE the server will be asked regardless if a previous call is cached.
   *
   ...
   *
   * @return object
   *   A response object filled with data from Elasticsearch's Luke.
   *
   * @throws \Drupal\search_api_elasticsearch\SearchApiElasticsearchException
   */
  ...
  /**
   * Pings the Elasticsearch core to tell whether it can be accessed.
   *
   * @return mixed
  ...
  /**
   * Gets summary information about the Elasticsearch Core.
   *
   * @return array
   *   An array of stats about the elasticsearch core.
   *
   * @throws \Drupal\search_api_elasticsearch\SearchApiElasticsearchException
   */
  ...
  /**
   * Sends a REST GET request to the Elasticsearch core and returns the result.
   *
   * @param string $path
  ...
  /**
   * Sends a REST POST request to the Elasticsearch core and returns the result.
   *
   * @param string $path
   *   The path to append to the base URI.
  ...
  /**
   * Sends a REST GET request to the Elasticsearch server and returns the result.
   *
   * @param string $path
   *   The path to append to the base URI.
   *
  ...
  /**
   * Sends a REST POST request to the Elasticsearch server and returns the result.
   *
   * @param string $path
   *   The path to append to the base URI.
   * @param string $command_json
  ...
  /**
   * Optimizes the Elasticsearch index.
   *
   * @param \Solarium\Core\Client\Endpoint|null $endpoint
   */
  ...
  /**
   * Retrieves a config file or file list from the Elasticsearch server.
   *
